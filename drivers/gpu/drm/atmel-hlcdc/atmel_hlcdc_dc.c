...
static const struct atmel_hlcdc_layer_desc atmel_hlcdc_sam9x5_layers[] = {
	{
		.name = "base",
		.formats = &atmel_hlcdc_plane_rgb_formats,
		.regs_offset = 0x40,
...
static const struct atmel_hlcdc_dc_desc atmel_hlcdc_dc_sam9x5 = {
	.min_width = 0,
	.min_height = 0,
	.max_width = 800,
	.max_height = 600,
	.nlayers = ARRAY_SIZE(atmel_hlcdc_sam9x5_layers),
	.layers = atmel_hlcdc_sam9x5_layers,
};
...
static void atmel_hlcdc_fb_output_poll_changed(struct drm_device *dev)
{
	...
	if (dc->fbdev) {
		...
		dc->fbdev = drm_fbdev_cma_init(dev, 16,
